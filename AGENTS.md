...
This file governs Codex's behavior in the **BidStack 360°** repository. Two sections: **Conduct** (universal) and **Architecture** (project-specific).
...
├── .Codex/              # Hooks, agents, project rules
├── AGENTS.md             # this file
