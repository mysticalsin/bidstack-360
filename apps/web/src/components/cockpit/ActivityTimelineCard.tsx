        ...
        <ol className="relative">
          {items.map((activity, i) => (
            ...
            >
              <span
                aria-hidden
                className="activity-kind-icon mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-[var(--border-default)] bg-[var(--surface-card)]"
              >
