...
export function DPAPage() {
  useSeo({
    title: 'Data Processing Agreement — BidStack 360°',
    description:
      'BidStack Data Processing Agreement (Article 28 GDPR). Subject matter, duration, processing instructions, sub-processors, security measures, and audit rights.',
  ...
  return (
    <LegalLayout
      ...
      intro={
        <p>
          ...
          <strong>[COMPANY NAME]</strong> (&ldquo;BidStack&rdquo;, the &ldquo;data processor&rdquo;)
          and reflects the parties&apos; agreement with regard to the processing of Personal Data
          by BidStack on behalf of Customer in accordance with the requirements of Article 28 of
    ...
    >
      ...
      <ul>
        ...
        <li>
          <strong>Sub-processor</strong> — any third party engaged by BidStack to process Personal
      ...
      <p>
        <strong>Subject matter:</strong> Provision of the BidStack 360° services as described in
      ...
      <p>
        BidStack processes Personal Data on Customer&apos;s behalf to provide the Services,
      ...
      <p>
        BidStack shall process Personal Data only on documented instructions from Customer,
      ...
      <p>
        BidStack ensures that personnel authorised to process Personal Data have committed
      ...
      <p>
        BidStack implements appropriate technical and organisational measures to ensure a level
      ...
      <p>
        Customer hereby grants BidStack a general written authorisation to engage sub-processors,
        provided that:
      </p>
      <ul>
        <li>BidStack maintains a current list of sub-processors (see the Privacy Policy).</li>
        <li>
          BidStack notifies Customer of any intended addition or replacement of a sub-processor at
          least 30 days in advance and gives Customer the opportunity to object on reasonable
          grounds related to data protection.
        </li>
        <li>
          BidStack imposes data protection obligations on each sub-processor that are no less
          protective than those in this DPA, by way of a written contract.
        </li>
        <li>
          BidStack remains fully liable to Customer for the performance of each sub-processor.
        </li>
      </ul>

      <h2>9. Data Subject rights</h2>
      <p>
        Taking into account the nature of the processing, BidStack shall assist Customer by
      ...
      <p>
        ...
        self-service tools, BidStack will assist Customer within 7 business days.
      </p>

      <h2>10. Personal data breach notification</h2>
      <p>
        BidStack shall notify Customer without undue delay and, where feasible, no later than 48
      ...
      <p>
        BidStack provides reasonable assistance to Customer with any Data Protection Impact
      ...
      <p>
        BidStack makes available to Customer all information necessary to demonstrate compliance
        ...
        BidStack&apos;s data processing activities to verify compliance. Audits must be conducted
        in a manner that does not unreasonably disrupt BidStack&apos;s operations or other
        customers, and the auditor must enter a reasonable confidentiality agreement.
      </p>

      <h2>13. Return and deletion of Personal Data</h2>
      <p>
        Upon termination of the Services, BidStack shall, at Customer&apos;s choice, return or
