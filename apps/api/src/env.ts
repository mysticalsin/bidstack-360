...
export const envSchema = z.object({
  ...
  // Sillage buying-intent signals. Platform-level credentials (one Sillage config
  // per deployment, not per-org BYO) — same trust class as Seamless/Apollo. MCP is
  ...
  SILLAGE_MCP_SIGNALS_TOOL: z.string().min(1).optional().or(z.literal('')),
