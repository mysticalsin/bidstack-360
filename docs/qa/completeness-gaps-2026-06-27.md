...
8. [ ] **E-sign send/track partially mounted** (`SendForSignatureModal.tsx` is now mounted from opportunity Documents and covered by Chromium E2E). Remaining: ProposalDetailPage/inbox entry points and richer tracking workflow. (M)
