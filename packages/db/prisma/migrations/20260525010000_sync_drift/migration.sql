-- ⚠️  WARNING: DESTRUCTIVE BASELINE MIGRATION ⚠️
-- This migration drops and recreates constraints, indexes, and schema objects
-- to resolve drift accumulated during rapid prototyping.
--
...
--   3. DBA review
--
-- If this migration has already been applied, DO NOT EDIT THIS FILE.
-- Create a new incremental migration instead (see MIGRATION_HYGIENE.md).
-- ---------------------------------------------------------------------------
